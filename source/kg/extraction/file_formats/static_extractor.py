...
from source.kg.extraction.file_formats.apache_vhost import extract_apache_vhost_routes
from source.kg.extraction.file_formats.deploy_events import extract_deploy_events
from source.kg.extraction.file_formats.domain_env import extract_domain_env
from source.kg.extraction.file_formats.dotenv import extract_dotenv
from source.kg.extraction.file_formats.endpoints import extract_endpoints
from source.kg.extraction.file_formats.serverless_yaml import extract_serverless_yaml_routes, is_serverless_yaml_filename
from source.kg.extraction.file_formats.terraform import extract_terraform
from source.kg.extraction.file_formats.zappa import extract_zappa_event_sources
...
class StaticConfigExtractor:
    ...
    def extract(
        ...
        if self.include_deploy_events:
            ...
            for scanned in files:
                if is_serverless_yaml_filename(scanned.path.name):
