...
- For Python AST semantics, test language rules that affect binding before PR: positional-only parameters, duplicate argument binding, keyword-only parameters, local assignment/import/loop/with/except shadowing, parameter shadowing, lambda bodies, and nested function/class scopes.
