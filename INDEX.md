...
| [adr/0003-postgres-age-as-initial-graph-storage.md](adr/0003-postgres-age-as-initial-graph-storage.md) | Storage | Initial Postgres plus Apache AGE storage decision, with current JSONL local-harness implementation status and backend-modularity constraints. Read before changing storage substrate, snapshot/query abstractions, or graph projection assumptions. |
