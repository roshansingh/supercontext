...
class McpSkillInstallerTest(unittest.TestCase):
    def test_project_install_copies_only_supercontext_mcp_skills(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("org snapshot", codex_skill)
            self.assertIn("same planning_context and review_context tools", codex_skill)
            self.assertIn("supercontext org serve", codex_skill)
            ...
            self.assertIn("org snapshot", claude_skill)
            self.assertIn("same planning_context and review_context tools", claude_skill)
            self.assertIn("supercontext org serve", claude_skill)
